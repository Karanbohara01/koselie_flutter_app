...
//     tokenResult.fold(
//       (failure) =>
//           emit(AuthUnauthenticated()), // Handle token retrieval failure
//       (token) {
//         if (token != null && token.isNotEmpty) {
//           emit(AuthAuthenticated(token: token)); // ✅ User is authenticated
//         } else {
//           emit(AuthUnauthenticated()); // ❌ No token found
//         }
//       },
//     );
//   }
...
//     await logoutUseCase();
//     emit(AuthUnauthenticated()); // ✅ User is logged out
//   }
// }
